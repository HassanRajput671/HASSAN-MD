...
cmd({
  ...
  try {
    ...
    let responseText = `*🤍 HASSAN-MD LOGO MAKER 💫*\n\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n`
    + `*◈ Text:* ${q}\n`
    + `╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼╼➻\n\n`
    ...
    conn.ev.on('messages.upsert', async (event) => {
      ...
      if (receivedMessage.message.extendedTextMessage.contextInfo && 
        ...
        if (logoUrls[receivedText]) {
          ...
          await conn.sendMessage(from, { image: { url: response.result.download_url }, caption: "> *© Powered By Hᴀssᴀɴ Rᴀᴊᴘᴏᴏᴛ²⁴³⁰*" }, { quoted });
        } else {
