...
cmd({  
  ...
  try {  
    await reply("```🔍 Checking for HASSAN-MD updates...```\n");  
    ...
    if (latestCommitHash === currentHash) {  
      return reply("```✅ Your HASSAN-MD bot is already up-to-date!```\n");  
    }  

    await reply("```HASSAN-MD Bot Updating...🚀```\n");  
    ...
    const sourcePath = path.join(extractPath, "HASSAN-MD-main");  
