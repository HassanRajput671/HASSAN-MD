...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Validate input
        if (!q) {
            return await reply("*Example -* .pair +923286813XXX");
        }

        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://hassan-md-pair-e0266498dec3.herokuapp.com/pair?phone=${q}`);
        ...
        const doneMessage = "> *HASSAN-MD PAIR COMPLETED*";
