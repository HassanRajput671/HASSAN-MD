const {
  ...
  const ownerNumber = ['923286813475']
...
const sessdata = config.SESSION_ID.replace("HASSAN-MD~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hello there HASSAN-MD User! \ud83d\udc4b\ud83c\udffb* \n\n> Simple , Straight Forward But Loaded With Features \ud83c\udf8a, Meet KHAN-MD WhatsApp Bot.\n\n *Thanks for using HASSAN-MD \ud83d\udea9* \n\n> Join WhatsApp Channel :- ⤵️\n \nhttps://whatsapp.com/channel/0029Vb0y7mxBvvskntdFVp32\n\n- *YOUR PREFIX:* = ${prefix}\n\nDont forget to give star to repo ⬇️\n\nhttps://github.com/HassanRajput671/HASSAN-MD\n\n> © Powered BY Hassan Rajpoot²⁴³⁰ \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://i.ibb.co/FbbBFGpF/7099.jpg` }, caption: up })
  }
  })
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('92386813475', '923201713746', '923023763212');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("923286813475")){
  if(isReact) return
  m.react("🦋")
   }
  //==========public react============//
